...
eachSuite
  .add('lodash', () => _.each(arr, String))
  .add('underscore', () => __.each(arr, String))
  .add('native', () => arr.forEach(String))
  .run({ 'async': true });
